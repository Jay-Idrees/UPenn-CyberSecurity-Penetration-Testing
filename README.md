...
- Once you are able to break into a machine you can run **Meterpreter** on the target or transfer `payloads`. The goal of the paylod is to establish a shell which intern can be **bind shells** - hacker connects to victim or **reverse shells** - victim connects to hacker
